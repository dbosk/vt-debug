...
% XXX Select the concrete SCS1 subset (informed by the IRT results in
% SCS1IRT and the shortened version in SCS1Short) when finalising the
% quiz; the selected items then join the list above.
