...
% XXX Decide the quiz contents.  Candidates to capture alongside prior
% knowledge: languages known and years of experience, whether they know
% Python specifically, prior debugging habits (what they do when a program
% misbehaves), programming self-efficacy, and how they plan to study
% (baseline for the material-use self-report).
