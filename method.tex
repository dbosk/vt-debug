...
And being our own, they can be published in full (\cref{app:quiz}).
The quizzes replace the earlier course instances' diagnostic tests, and
are inspired by them; those tests were written by Emma Riese and
Camilla Björn.
