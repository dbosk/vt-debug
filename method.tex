...
At the start of the course we use the items in their original wording,
with the students instructed to answer with their studies in general in
mind.
% XXX Enumerate the 20 items verbatim from the appendix of Biggs et al.
% (2001) here; insert and verify against the original before the course
% starts.

\paragraph{The items at the end of the course}

At the end of the course we use the same 20 items, with the instructions
(and, where needed, the wording) referring to this course instead of to
the student's studies in general, in line with the instrument's intended
use by teachers evaluating their own course \autocite{RSPQ2F}.
The two administrations thus differ only in this reframing, so that the
start and end scores remain comparable while measuring the general and
the course-specific approach, respectively.
% XXX Enumerate the adapted items alongside the originals once those are
% inserted above.
