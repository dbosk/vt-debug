...
For the knowledge part itself we use the questions of the course's
example exam---as many as fit alongside the approach questionnaire (the
R-SPQ-2F, which we introduce in \cref{approach-measure}) and the
background items above---improved where needed and translated into
English.
...
% XXX(#4) Select, improve and translate the example-exam questions and
% add them to the quiz program (app:quiz).
