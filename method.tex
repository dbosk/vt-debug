...
Besides prior programming knowledge, the quiz asks the following; with
each question we give the reason for asking it.
...
\begin{enumerate}
  ...
  \item \enquote{If you have programmed before: how did you learn---in a
    ...
    directly on the deep approach (\cref{rq:deep}): they may already
    generate their own variation.
  ...
  \item \enquote{How do you plan to study in this course: mainly from the
    ...
    (\cref{material-use}), and thereby for the generative-learning
    comparison it supports (\cref{rq:generative}).
\end{enumerate}
