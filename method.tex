...
\begin{enumerate}[resume]
  \item \enquote{Here is a small Python program, and what happened when
    it was run.
...
101010
\end{minted}
    \enquote{How would you go about finding out what is wrong?
...
% XXX(#4) Decide between the SCS1 subset and the Nordic Prior Knowledge Test
