...
\end{enumerate}
This is the baseline for the material-use self-report
(\cref{material-use}), and thereby for the generative-learning comparison
it supports (\cref{rq:generative}).
