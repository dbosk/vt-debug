...
between approach and patterns (\cref{rq:deep}).
\begin{enumerate}[resume]
...
We can therefore also compare the coded episodes, the students' and the
teachers' alike, with the prescriptions of the systematic-debugging
literature: the prescribed hypothesis--experiment cycle should show up
in our coding as the contrast and generalisation patterns.
...
is not a fixed trait---students adapt it to their conception of the task
