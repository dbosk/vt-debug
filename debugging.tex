...
% XXX(#2) Test with more colleagues.
% Tested with Alexander.
% TODO(#3) Expand this section with details from the recorded sessions (see the
...
reported here.
% TODO(#3) Transcribe and analyse the two recorded sessions (KTH Play playlist in
% debug_data/data.md); report the coded episodes here.
% XXX(#3) Stub: per-session summaries to be added.
