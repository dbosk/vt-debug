...
\begin{restatable}{question}{rqschool}\label{rq:school}
  How does the type of principal (\emph{huvudman}) of the schools a
  student attended before the course relate to the approach to learning
  they bring to it, and to how they fare in it?
\end{restatable}
\end{frame}
...
type of principal that ran them can be related to both the approach
measure and the course outcomes without asking the students to judge
anything.
...
\begin{itemize}
  ...
  \item An exploratory link between the schooling a student brings and
    ...
    register rather than from self-report, related to the approach
    measure and to the course outcomes (\cref{rq:school}).
