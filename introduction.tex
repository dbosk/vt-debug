...
\begin{question}\label{rq:patterns}
  \rqpatterns
\end{question}
\begin{question}\label{rq:deep}
  \rqdeep
\end{question}
\begin{question}\label{rq:success}
  \rqsuccess
\end{question}
\begin{question}\label{rq:experts}
  \rqexperts
\end{question}
\end{frame}
...
A fifth question, which follows from the theory we develop in
\cref{debugging-as-learning}, is stated there (\cref{rq:generative}); it is
...
In \cref{method} we describe the planned study, in \cref{results} the expected
results, and in \cref{discussion} we conclude.
