...
A last prediction comes from outside this argument altogether.
In \cref{schooling} we conjectured that the Swedish grading pattern---grades
that run ahead of what external assessment shows, and first-year university
credits that fall short of what those grades predict---is what one would
expect if the students had been rewarded for reproducing the assessed
material, which is the surface approach.
Read as a claim about the students who arrive in this course, the conjecture
predicts the following.

\begin{frame}
  \begin{restatable}{hypothesis}{hschool}\label{h:school}
    Students whose previous schools had an independent principal---above
    all at gymnasiet, where the grading evidence is strongest---score
    further towards the surface approach on the R-SPQ-2F, and are
    over-represented among the students with the weakest outcomes in the
    course.
  \end{restatable}
\end{frame}

\Cref{h:school} is our predicted answer to \cref{rq:school}, and it is the
most speculative of the five: the mechanism it names is our conjecture and
not a finding of the literature, which offers a rival explanation on the
supply side---schools responding to different educational preferences
rather than students learning differently
\autocite[pp.~40--41]{HinnerichVlachos2017}.
The variable is weak as well.
Skolverket puts the share of the between-school variation in grading that
the huvudman type explains at about \(1.5\) per cent in year~9
\autocite[p.~30]{Skolverket2019Betyg} and \(0.5\)--\(1\) per cent in the
gymnasium \autocite[p.~46]{Skolverket2020Betyg}, and the spread within the
independent sector is wider than the gap between the sectors
\autocite[p.~26]{Skolverket2019Betyg}.
The huvudman type is therefore a weak, exploratory covariate and never a
grouping we lead with: a null result would say almost nothing, and a
positive one would be a starting point rather than a finding.
We treat \cref{rq:school} accordingly in \cref{analysis}, and return to
what it cannot show in \cref{discussion}.
