...
The knowledge part of the diagnostic quiz uses the course's example
exam rather than an established concept inventory
(\cref{prior-knowledge}); since the inventories are well developed, the
choice deserves a discussion.
...
Their items measure generic CS1 knowledge, while the example exam's
questions are constructed against the course's intended learning
outcomes---and prior knowledge and knowledge gain \emph{in terms of
what the course intends to teach} is what our hypotheses need
...
cannot show its instrument, whereas the exam questions appear in full
in \cref{app:quiz}.
