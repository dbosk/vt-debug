...
classification in the think-aloud subsample (\cref{approach-measure}) is
meant to catch this.
...
The think-aloud validation sessions (\cref{method}) are meant to bound this
...
We will collect self-reported prior experience and control for it.
The within-cohort comparison between material users and self-studiers is
self-selected, not randomised: the students who skip the course material may
